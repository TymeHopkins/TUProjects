...
//Define the register the MPU6050 is stored in???
#define MPU6050_ADDR 0xD0

//Defined register locations that the MPU6050 data is stored in???
...
//Define variables to store the x, y, z data collected by the accelerometer
int16_t Accel_X_RAW, Accel_Y_RAW, Accel_Z_RAW;
//Define variables to store the x, y, z data collected by the gyroscope
